...
const generateRelationTypeOptions = (knownRelationTypes: string[]): INodeProperties[] => {
	...
	return [
		// Default exists, but is not detected by eslint
...
export const relationOperations: INodeProperties[] = [
	{
		...
		options: [
			...
			},
			{
				...
				value: 'update',
				description:
					'Update a relation. Many relations cannot be modified, but they can be created and deleted.',
			},
			{
				name: 'Delete',
				value: 'delete',
		...
		options: [
			{
				...
				description:
					'For now, only the confirmation status of an appointment can be set by relationinfo. The key for that is statusTerminbestaetigung. The possible values are: bestätigt (confirmed), gesendet (sent), gecancelt (cancelled), nicht gesetzt (not set)',
				name: 'relationInfo',
						...
						values: [
							{
								...
								description:
									'Name of the property. For now, only the confirmation status of an appointment can be set by relationinfo. For the values are: bestätigt (confirmed), gesendet (sent), gecancelt (cancelled), nicht gesetzt (not set)',
								type: 'string',
							},
							{
								displayName: 'Value',
